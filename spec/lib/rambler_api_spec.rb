...
describe RamblerApi do
  ...
  let(:recommendation) do
    Recommendation.new(
        ...
        :price_fare => 1000,
        :price_tax => 2000
    ).tap {|r| r.stub(:price_with_payment_commission, 0)}
  end
  ...
  it 'should generate correct url' do
    ...
    uri.should include("amadeus.SU.0.MNK.YYY..SU:UN100SVOLED#{future_date}-UN200LEDYXU#{future_date}.BP:UN300YXUSVO#{future_date(2)}")
  end
  ...
  it 'should generate correct redirect again' do
    ...
    uri.should include("amadeus.PS.0.NN.YY..S7:PS9032KUFDME#{future_date}-PS574DMEKBP#{future_date}")
  end
