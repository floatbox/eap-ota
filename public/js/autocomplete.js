/*
    ...
    БЛЯ
    я не могу фигачить дальше, т.к. нету
        - сервиса геолокации
        - разбора строки
    ...
    КОСЯКИ
    + Tab, Enter при наличии выделения в строке (автоФилл) должен закрывать список и снимать выделение
    + IE: Esc в не только закрывает список, но и ставит курсор в конец текста
