...
subagent "3%"
discount "1.5%"
agent_comment "Открыть выписку S7 на билеты код-шеринг и интерлайн в офисе MOWR228FA."
agent_comment "Агентская комиссия 3%"
subagent_comment "Субагентская комиссия 3%"
interline :no, :yes
...
subagent "0%"
our_markup "400"
agent_comment "рейсы код-шеринг и интерлайн без комиссии c дополнительным сбором 400 руб за билет"
subagent_comment "0%"
interline :no, :yes
example "svocdg/ab cdgsvo"
example "ledcdg/fv:s7 cdgled"
