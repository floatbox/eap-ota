...
swarnings: {
    ...
    mwsegments: ['первого перелёта', 'второго перелёта', 'третьего перелёта'],
    persons: 'Количество пассажиров не должно быть больше восьми',
    infants: 'Количество младенцев не должно быть больше количества взрослых'
},
numbers: {
...
offers: {
    ...
    price: {
        buy: 'Купить за {0}',
        one: '— итоговая цена со всеми сборами',
        many: '— итоговая цена за всех со всеми сборами',
        rise: 'на {0} дороже',
        fall: 'на {0} дешевле',
        from: 'от {0}'
    },
...
title: {
    ...
    booking: 'Бронирование авиабилетов {0}'
},
currencies: {
