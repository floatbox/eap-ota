...
subagent "7,5% от опубл. тарифов на собств. рейсы CA по маршрутам Москва-Пекин или Москва-Пекин-Москва и далее в третий пункт (кроме класса E и рейсов совместной эксплуатации) или города Китая (классы S, G и выше)."
...
subagent "3,5% от опубл. тарифов CA на все прочие собств. рейсы CA, кроме указанных выше, все рейсы совместной эксплуатации, а также на рейсы из Москвы, Екатеринбурга и Читы;"
check { includes( %W(SVX HTA SVO), city_iatas.first) }
...
subagent "5 руб. билета по опубл. тарифам на собств. рейсы СА если первый сегмент из России, далее на ресах совместной эксплуатации."
...
subagent "0% от опубл. тарифа на собств. рейсы СА если первый сегмент не из России;"
...
subagent "4% по выписанным билетам с 14.11.2011г. по 31.03.2012г. (включая обе даты) по опубл. тарифов классов J,C,D,Y,M,B,H,K,T,A,L,X,Q,U,V,N. с вылетом из городов РФ в любой из городов маршрутной сети OK, включая рейсы code-share."
...
subagent "0,5% от опубл. тарифов и конфиде. тарифов на междунар. и внутр. рейсы A3. Билеты по Interline могут быть выписаны только при условии присутствия сегментов A3"
interline :half
commission "1%/0.5%"
