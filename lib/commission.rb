...
international
disabled "возможно, конфликтует с 6%/4%"
commission "7%/5%"
...
# FIXME поставить пониже, если интерлайн будет
# example 'ufasvx svxufa'
# important!
# check { city_iatas.include?('SVX') }
# no_commission
