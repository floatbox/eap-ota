...
subagent "3,0 (три) % от тарифов, (в т.ч. при переоформлении авиабилета с доплатой по тарифу)."
subagent "на рейсы Interline без комбинации с рейсом под кодом «SU»:"
subagent "5 (пять) руб. с авиабилета."
...
subagent "При продаже авиаперевозок на рейсы авиакомпании ОАО «АВИАЦИОННАЯ КОМПАНИЯ «ТРАНСАЭРО» (код УН) с расчетным кодом 670 (кроме перевозок по интерлайн-соглашениям) на рейсы «УН», а также с расчетным кодом 99А на рейсы «УН» комиссионное вознаграждение Субагента составит:"
