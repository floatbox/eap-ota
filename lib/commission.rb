...
important!
check { includes_only(city_iatas, "MOW SIN") and includes_only(city_iatas, "MOW HOU") } #FIX неполный чек
disabled "На DTT выгодней"
discount "6.5%"
commission "9%/7%"

# Пекин/Майами/Нью-Йорк прямые из Москвы и сквозные через Москву из RU UA KZ UZ AM
...
subagent "10% до особых указаний от всех опубл. тарифов (OW/RT) на собств. ПРЯМЫЕ рейсы UN между Москвой и городами:Нью-Йорк/ Майами/ Лос-Анджелес/ Пекин;"
...
disabled "пока не пропишем routes для страны выключил"
discount "3.5%"
commission "6%/4%"
