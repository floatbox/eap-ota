...
important!
check { country_iatas.first == 'RU' }
subclasses "JCDAZSYHMQBKORELVXTNIGWU"
...
example 'svocdg'
agent "0,5% от опубл. тарифов на собств. рейсы 5L"
subagent "5 руб. с билета по опубл. тарифам на собств. рейсы 5L"
commission "0.5%/5"

example 'svocdg cdgsvo/ab'
agent "0,5% от опубл. тарифов на собств. рейсы 5L"
subagent "5 руб. с билета по опубл. тарифам на собств. рейсы 5L"
interline :unconfirmed
commission "0.5%/5"
...
agent "0,5% от опубл. тарифов и конфиде. тарифов на междунар. и внутр. рейсы A3. Билеты по Interline могут быть выписаны только при условии присутствия сегментов A3."
...
example 'svocdg'
agent "0,5% от опубл. тарифов на собств. рейсы MD"
