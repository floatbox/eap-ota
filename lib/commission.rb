...
agent    "C 01.04.11г. по 31.12.11г. 9% от опубл. тарифов на междунар.рейсах VN"
...
example 'svocdg'
example 'svocdg/business'
agent    "7% от опубл. тарифов на международные перевозки;"
subagent "5% от опубл. тарифов на международные перевозки;"
international
commission "7%/5%"

example 'svxaer aerdme dmesvx' # пока считаем тоже здесь
example 'dmepee'
agent    "6% от опубл. тарифов на перевозки по России в Эконом классе;"
...
agent    "9% от опубл. тарифов на перевозки по России в Бизнес классе;"
...
example 'dmemsq'
example 'svxdme dmemsq'
agent    "6% от опубл. тарифов за продажу перевозок по СНГ, МВЛ и продажу трансферных перевозок по сквозным тарифам и трансферных перевозок  по сквозным тарифам, полученным путем end-on-end комбинации опубликованных тарифов перевозчиков"
...
important!
# снг
check { country_iatas.any? {|code| %W(AM AZ BY KZ KG MD TJ TM UZ UA).include?(code) } }
commission '6%/4%'

example 'dmemsq msqdme/ab'
agent    "3% от опубл. тарифов на рейсы Interline с участком U6;"
...
agent "1 евро от всех опубл. и конфиде. тарифов на международные и внутренние рейсы A3. Билеты по Interline могут быть выписаны только при условии присутствия сегментов A3."
subagent ""
interline :possible
disabled
commission "1eur/0"
