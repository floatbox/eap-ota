...
agent "C 01.04.11г. по 30.04.11г."
agent "5% от опубл. тарифов Эконом класса на собств. рейсы AZ"
agent "Условия предоставления комиссии: "
agent "Период действия комиссии с 1 апреля по 30 апреля 2011 года "
...
example 'svocdg'
agent "3 % от всех опубликованных тарифов; (Interline отдельно не прописан)"
