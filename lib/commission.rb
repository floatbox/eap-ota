...
example 'mowsel'
agent    "9% от опубл. тарифов на собственные рейсы KE только с вылетом из России"
subagent "6,3% от опубл. тарифов на собственные рейсы KE только с вылетом из России"
#geo
not_implemented
commission "9%/6.3%"
