  ...
  module ActiveRecordExt
    ...
    module Cases
      ...
      def save_guessed
        ...
        update_attributes(:morpher_to => "#{pr} #{(cases[3]).chomp}", :morpher_from => "из #{(cases[1]).chomp}", :morpher_in => "#{pr} #{(cases[5]).chomp}" ) if cases[3].presense && cases[5].presense && cases[1].presense
      end
